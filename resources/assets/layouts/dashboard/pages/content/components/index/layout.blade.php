                ...
                <div class="modal-body">
                    <form>
                        ...
                        <div class="form-group hidden">
                            ...
                            <input class="form-control" type="text" id="modal_date" placeholder="@lang('dashboard.components.modal.dateDesc') @lang('dashboard.components.modal.date')" autocomplete="off">
                        </div>
                        <div class="form-group hidden">
